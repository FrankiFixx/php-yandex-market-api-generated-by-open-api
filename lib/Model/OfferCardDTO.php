...
class OfferCardDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'mapping' => '\OpenAPI\Client\Model\GetMappingDTO',
        'card_status' => '\OpenAPI\Client\Model\OfferCardStatusType',
        'content_rating' => 'int',
        'recommendations' => '\OpenAPI\Client\Model\OfferCardRecommendationDTO[]',
    ...
    */
     ...
     * Gets mapping
     *
     * @return \OpenAPI\Client\Model\GetMappingDTO|null
     */
     ...
     * Sets mapping
     *
     * @param \OpenAPI\Client\Model\GetMappingDTO|null $mapping mapping
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\OfferCardRecommendationDTO[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\OfferCardRecommendationDTO[]|null $recommendations Список рекомендаций к заполнению карточки.  Рекомендации Маркета помогают заполнять карточку так, чтобы покупателям было проще найти ваш товар и решиться на покупку.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\OfferErrorDTO[]|null $errors Ошибки в контенте, препятствующие размещению товара на витрине.
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \OpenAPI\Client\Model\OfferErrorDTO[]|null $warnings Связанные с контентом предупреждения, не препятствующие размещению товара на витрине.
     *
     * @return self
     */
