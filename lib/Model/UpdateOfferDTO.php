...
class UpdateOfferDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'purchase_price' => '\OpenAPI\Client\Model\BasePriceDTO',
        'additional_expenses' => '\OpenAPI\Client\Model\BasePriceDTO',
        'cofinance_price' => '\OpenAPI\Client\Model\BasePriceDTO'
    ];
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 6000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateOfferDTO., must be smaller than or equal to 6000.');
        }
     ...
     * Sets purchase_price
     *
     * @param \OpenAPI\Client\Model\BasePriceDTO|null $purchase_price purchase_price
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BasePriceDTO|null $additional_expenses additional_expenses
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BasePriceDTO|null $cofinance_price cofinance_price
     *
     * @return self
     */
