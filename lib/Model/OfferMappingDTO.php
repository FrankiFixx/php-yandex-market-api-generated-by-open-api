 ...
 */
class OfferMappingDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferMappingDTO';
    ...
    */
     ...
     * Sets category_id
     *
     * @param int|null $category_id Идентификатор категории для текущей карточки товара на Маркете.
     *
     * @return self
     */
