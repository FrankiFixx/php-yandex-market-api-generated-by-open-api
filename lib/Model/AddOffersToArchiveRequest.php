...
/**
 * AddOffersToArchiveRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AddOffersToArchiveRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddOffersToArchiveRequest';
    ...
    */
     ...
     * Sets offer_ids
     *
     * @param string[] $offer_ids Список товаров, которые нужно поместить в архив.
     *
     * @return self
     */
    public function setOfferIds($offer_ids)
    {
        ...
        if ((count($offer_ids) > 200)) {
            throw new \InvalidArgumentException('invalid value for $offer_ids when calling AddOffersToArchiveRequest., number of items must be less than or equal to 200.');
        }
        if ((count($offer_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_ids when calling AddOffersToArchiveRequest., number of items must be greater than or equal to 1.');
        }
