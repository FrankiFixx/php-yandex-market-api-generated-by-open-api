...
class OfferContentDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'category_id' => 'int',
        'parameter_values' => '\OpenAPI\Client\Model\ParameterValueDTO[]'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\ParameterValueDTO[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ParameterValueDTO[] $parameter_values Список характеристик с их значениями. Обновляется всегда целиком. Максимальное количество — 300.
     *
     * @return self
     */
