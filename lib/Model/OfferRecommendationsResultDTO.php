...
/**
 * OfferRecommendationsResultDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class OfferRecommendationsResultDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferRecommendationsResultDTO';
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\OfferRecommendationDTO[]|null
     */
    public function getOfferRecommendations()
    {
        return $this->container['offer_recommendations'];
    }

    /**
     * Sets offer_recommendations
     *
     * @param \OpenAPI\Client\Model\OfferRecommendationDTO[]|null $offer_recommendations Страница списка товаров.
     *
     * @return self
     */
    public function setOfferRecommendations($offer_recommendations)
    {
        if (is_null($offer_recommendations)) {
            throw new \InvalidArgumentException('non-nullable offer_recommendations cannot be null');
        }
        $this->container['offer_recommendations'] = $offer_recommendations;
