...
/**
 * DeleteOffersFromArchiveRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class DeleteOffersFromArchiveRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteOffersFromArchiveRequest';
    ...
    */
     ...
     * Sets offer_ids
     *
     * @param string[] $offer_ids Список товаров, которые нужно восстановить из архива.
     *
     * @return self
     */
    public function setOfferIds($offer_ids)
    {
        ...
        if ((count($offer_ids) > 200)) {
            throw new \InvalidArgumentException('invalid value for $offer_ids when calling DeleteOffersFromArchiveRequest., number of items must be less than or equal to 200.');
        }
        if ((count($offer_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_ids when calling DeleteOffersFromArchiveRequest., number of items must be greater than or equal to 1.');
        }
