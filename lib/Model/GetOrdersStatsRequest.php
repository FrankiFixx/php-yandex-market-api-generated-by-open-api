...
class GetOrdersStatsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrdersStatsRequest';
    ...
    */
     ...
     * @return self
     */
    public function setUpdateFrom($update_from)
    {
     ...
     * @return self
     */
    public function setUpdateTo($update_to)
    {
     ...
     * @return self
     */
    public function setHasCis($has_cis)
    {
        if (is_null($has_cis)) {
