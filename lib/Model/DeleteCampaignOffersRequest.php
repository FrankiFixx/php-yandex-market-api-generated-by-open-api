...
/**
 * DeleteCampaignOffersRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class DeleteCampaignOffersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteCampaignOffersRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['offer_ids']) > 500)) {
     ...
     * Sets offer_ids
     *
     * @param string[] $offer_ids Идентификаторы товаров в каталоге.
     *
     * @return self
     */
    public function setOfferIds($offer_ids)
    {
        ...
        if ((count($offer_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $offer_ids when calling DeleteCampaignOffersRequest., number of items must be less than or equal to 500.');
        }
        if ((count($offer_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_ids when calling DeleteCampaignOffersRequest., number of items must be greater than or equal to 1.');
        }
