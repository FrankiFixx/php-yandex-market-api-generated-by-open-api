...
/**
 * UpdatePriceWithDiscountDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdatePriceWithDiscountDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePriceWithDiscountDTO';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value <= 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling UpdatePriceWithDiscountDTO., must be bigger than 0.');
        }
     ...
     * Sets currency_id
     *
     * @param \OpenAPI\Client\Model\CurrencyType $currency_id currency_id
     *
     * @return self
     */
    ...
    public function setDiscountBase($discount_base)
    {
        ...
        if (($discount_base <= 0)) {
            throw new \InvalidArgumentException('invalid value for $discount_base when calling UpdatePriceWithDiscountDTO., must be bigger than 0.');
        }
