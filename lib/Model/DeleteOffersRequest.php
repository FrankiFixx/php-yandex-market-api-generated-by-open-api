...
/**
 * DeleteOffersRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class DeleteOffersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteOffersRequest';
    ...
    */
     ...
     * Sets offer_ids
     *
     * @param string[] $offer_ids Список SKU товаров, которые нужно удалить.
     *
     * @return self
     */
    public function setOfferIds($offer_ids)
    {
        ...
        if ((count($offer_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $offer_ids when calling DeleteOffersRequest., number of items must be less than or equal to 500.');
        }
        if ((count($offer_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_ids when calling DeleteOffersRequest., number of items must be greater than or equal to 1.');
        }
