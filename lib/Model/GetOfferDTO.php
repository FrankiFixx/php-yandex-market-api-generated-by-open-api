...
class GetOfferDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'purchase_price' => '\OpenAPI\Client\Model\GetPriceDTO',
        'additional_expenses' => '\OpenAPI\Client\Model\GetPriceDTO',
        'cofinance_price' => '\OpenAPI\Client\Model\GetPriceDTO',
        'card_status' => '\OpenAPI\Client\Model\OfferCardStatusType',
        'campaigns' => '\OpenAPI\Client\Model\OfferCampaignStatusDTO[]',
        'selling_programs' => '\OpenAPI\Client\Model\OfferSellingProgramDTO[]',
        'archived' => 'bool'
    ];
    ...
    */
    ...
    public function setOfferId($offer_id)
    {
        ...
        if ((mb_strlen($offer_id) > 80)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling GetOfferDTO., must be smaller than or equal to 80.');
        }
        ...
        if ((!preg_match("/^[0-9a-zа-яА-ЯA-ZёËëЁ.,\\\\\/()\\[\\]\\-=_]{1,80}$/", ObjectSerializer::toString($offer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$offer_id when calling GetOfferDTO., must conform to the pattern /^[0-9a-zа-яА-ЯA-ZёËëЁ.,\\\\\/()\\[\\]\\-=_]{1,80}$/.");
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 6000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling GetOfferDTO., must be smaller than or equal to 6000.');
        }
     ...
     * Sets purchase_price
     *
     * @param \OpenAPI\Client\Model\GetPriceDTO|null $purchase_price purchase_price
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\GetPriceDTO|null $additional_expenses additional_expenses
     *
     * @return self
     */
     ...
     * Sets card_status
     *
     * @param \OpenAPI\Client\Model\OfferCardStatusType|null $card_status card_status
     *
     * @return self
     */
     ...
     * Gets campaigns
     *
     * @return \OpenAPI\Client\Model\OfferCampaignStatusDTO[]|null
     */
     ...
     * Sets campaigns
     *
     * @param \OpenAPI\Client\Model\OfferCampaignStatusDTO[]|null $campaigns Список магазинов, в которых размещен товар.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\OfferSellingProgramDTO[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\OfferSellingProgramDTO[]|null $selling_programs Информация о том, какие для товара доступны модели размещения.
     *
     * @return self
     */
