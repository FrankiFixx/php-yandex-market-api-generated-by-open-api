...
/**
 * AddOffersToArchiveErrorDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class AddOffersToArchiveErrorDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddOffersToArchiveErrorDTO';
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'error' => '\OpenAPI\Client\Model\AddOffersToArchiveErrorType'
    ];
    ...
    */
    ...
    public function setOfferId($offer_id)
    {
        ...
        if ((mb_strlen($offer_id) > 80)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling AddOffersToArchiveErrorDTO., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($offer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling AddOffersToArchiveErrorDTO., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9a-zа-яА-ЯA-ZёËëЁ.,\\\\\/()\\[\\]\\-=_]{1,80}$/", ObjectSerializer::toString($offer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$offer_id when calling AddOffersToArchiveErrorDTO., must conform to the pattern /^[0-9a-zа-яА-ЯA-ZёËëЁ.,\\\\\/()\\[\\]\\-=_]{1,80}$/.");
        }
     ...
     * Gets error
     *
     * @return \OpenAPI\Client\Model\AddOffersToArchiveErrorType
     */
     ...
     * Sets error
     *
     * @param \OpenAPI\Client\Model\AddOffersToArchiveErrorType $error error
     *
     * @return self
     */
