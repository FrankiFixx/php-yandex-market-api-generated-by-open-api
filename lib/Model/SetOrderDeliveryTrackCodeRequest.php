...
/**
 * SetOrderDeliveryTrackCodeRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SetOrderDeliveryTrackCodeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetOrderDeliveryTrackCodeRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['track_code'] === null) {
            $invalidProperties[] = "'track_code' can't be null";
        }
    ...
    {
        return $this->container['track_code'];
    }

    /**
     * Sets track_code
     *
     * @param string $track_code Трек‑номер посылки.
     *
     * @return self
     */
    public function setTrackCode($track_code)
    {
        if (is_null($track_code)) {
            throw new \InvalidArgumentException('non-nullable track_code cannot be null');
        }
        $this->container['track_code'] = $track_code;
