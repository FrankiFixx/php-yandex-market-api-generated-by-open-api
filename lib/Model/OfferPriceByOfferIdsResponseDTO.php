...
/**
 * OfferPriceByOfferIdsResponseDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class OfferPriceByOfferIdsResponseDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferPriceByOfferIdsResponseDTO';
    ...
    */
    ...
    public function setOfferId($offer_id)
    {
        ...
        if ((mb_strlen($offer_id) > 80)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling OfferPriceByOfferIdsResponseDTO., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($offer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling OfferPriceByOfferIdsResponseDTO., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9a-zа-яА-ЯA-ZёËëЁ.,\\\\\/()\\[\\]\\-=_]{1,80}$/", ObjectSerializer::toString($offer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$offer_id when calling OfferPriceByOfferIdsResponseDTO., must conform to the pattern /^[0-9a-zа-яА-ЯA-ZёËëЁ.,\\\\\/()\\[\\]\\-=_]{1,80}$/.");
        }
     ...
     * Gets price
     *
     * @return \OpenAPI\Client\Model\PriceDTO|null
     */
     ...
     * Sets price
     *
     * @param \OpenAPI\Client\Model\PriceDTO|null $price price
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at Дата и время последнего обновления цены.
     *
     * @return self
     */
