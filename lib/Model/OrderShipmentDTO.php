...
class OrderShipmentDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'status' => '\OpenAPI\Client\Model\OrderParcelStatusType',
    ...
    */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\OrderParcelStatusType|null
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\OrderParcelStatusType|null $status status
     *
     * @return self
     */
     ...
     * Sets tracks
     *
     * @param \OpenAPI\Client\Model\OrderTrackDTO[]|null $tracks Информация для отслеживания перемещений посылки. Только для модели DBS.
     *
     * @return self
     */
