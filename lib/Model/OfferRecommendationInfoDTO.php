 ...
 */
class OfferRecommendationInfoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferRecommendationInfoDTO';
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'recommended_cofinance_price' => '\OpenAPI\Client\Model\BasePriceDTO',
        'competitiveness_thresholds' => '\OpenAPI\Client\Model\PriceCompetitivenessThresholdsDTO'
    ];
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\BasePriceDTO|null $recommended_cofinance_price recommended_cofinance_price
     *
     * @return self
     */
    ...
    /**
     * Gets competitiveness_thresholds
     *
     * @return \OpenAPI\Client\Model\PriceCompetitivenessThresholdsDTO|null
     */
    public function getCompetitivenessThresholds()
    {
        return $this->container['competitiveness_thresholds'];
    }

    /**
     * Sets competitiveness_thresholds
     *
     * @param \OpenAPI\Client\Model\PriceCompetitivenessThresholdsDTO|null $competitiveness_thresholds competitiveness_thresholds
     *
     * @return self
     */
    public function setCompetitivenessThresholds($competitiveness_thresholds)
    {
        if (is_null($competitiveness_thresholds)) {
            throw new \InvalidArgumentException('non-nullable competitiveness_thresholds cannot be null');
        }
        $this->container['competitiveness_thresholds'] = $competitiveness_thresholds;
