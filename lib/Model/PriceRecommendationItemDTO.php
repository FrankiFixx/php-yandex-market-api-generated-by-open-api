...
/**
 * PriceRecommendationItemDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class PriceRecommendationItemDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceRecommendationItemDTO';
    ...
    */
    ...
    public function setPrice($price)
    {
        ...
        if (($price < 1)) {
            throw new \InvalidArgumentException('invalid value for $price when calling PriceRecommendationItemDTO., must be bigger than or equal to 1.');
        }
