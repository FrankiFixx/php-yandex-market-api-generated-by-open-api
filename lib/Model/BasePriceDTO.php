...
/**
 * BasePriceDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class BasePriceDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BasePriceDTO';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value <= 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling BasePriceDTO., must be bigger than 0.');
        }
