...
/**
 * UpdateBusinessOfferPriceDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateBusinessOfferPriceDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateBusinessOfferPriceDTO';
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'price' => '\OpenAPI\Client\Model\UpdatePriceWithDiscountDTO'
    ];
    ...
    */
    ...
    public function setOfferId($offer_id)
    {
        ...
        if ((mb_strlen($offer_id) > 80)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling UpdateBusinessOfferPriceDTO., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($offer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_id when calling UpdateBusinessOfferPriceDTO., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9a-zа-яА-ЯA-ZёËëЁ.,\\\\\/()\\[\\]\\-=_]{1,80}$/", ObjectSerializer::toString($offer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$offer_id when calling UpdateBusinessOfferPriceDTO., must conform to the pattern /^[0-9a-zа-яА-ЯA-ZёËëЁ.,\\\\\/()\\[\\]\\-=_]{1,80}$/.");
        }
     ...
     * Gets price
     *
     * @return \OpenAPI\Client\Model\UpdatePriceWithDiscountDTO
     */
     ...
     * Sets price
     *
     * @param \OpenAPI\Client\Model\UpdatePriceWithDiscountDTO $price price
     *
     * @return self
     */
