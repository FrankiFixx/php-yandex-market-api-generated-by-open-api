...
class UpdateOfferContentResultDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'errors' => '\OpenAPI\Client\Model\OfferContentErrorDTO[]',
        'warnings' => '\OpenAPI\Client\Model\OfferContentErrorDTO[]'
    ];
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\OfferContentErrorDTO[]|null
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\OfferContentErrorDTO[]|null $errors Ошибки, препятствующие отправке контента в каталог.
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \OpenAPI\Client\Model\OfferContentErrorDTO[]|null $warnings Предупреждения, не препятствующие отправке контента в каталог.
     *
     * @return self
     */
