...
/**
 * ConfirmPricesRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ConfirmPricesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConfirmPricesRequest';
    ...
    */
     ...
     * Sets offer_ids
     *
     * @param string[] $offer_ids Идентификаторы товаров, у которых подтверждается цена.
     *
     * @return self
     */
