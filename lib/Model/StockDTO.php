...
class StockDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'sku' => 'string',
        'warehouse_id' => 'int',
        'items' => '\OpenAPI\Client\Model\StockItemDTO[]'
    ];
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((!preg_match("/^[0-9a-zа-яА-ЯA-ZёËëЁ.,\\\\\/()\\[\\]\\-=_]{1,80}$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling StockDTO., must conform to the pattern /^[0-9a-zа-яА-ЯA-ZёËëЁ.,\\\\\/()\\[\\]\\-=_]{1,80}$/.");
        }
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\StockItemDTO[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\StockItemDTO[] $items Информация об остатках товара на данном складе.
     *
     * @return self
     */
